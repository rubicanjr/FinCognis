...
139 agents. 293 skills. 71 hooks. Ноль ручной работы.
...
vibecosystem превращает Claude Code в полноценную ИИ-команду разработки. Не одного ассистента -- **команду** из 139 специализированных агентов, которые планируют, создают, проверяют, тестируют и учатся на каждой ошибке.
...
Существует 66 хуков, но они не запускаются все одновременно. Намерение определяет, какие хуки срабатывают.
