      ...
      <div className="grid h-auto grid-cols-1 gap-6 md:h-[600px] md:grid-cols-12">
        <div className="glass-panel group relative flex flex-col justify-between overflow-hidden rounded-3xl p-8 md:col-span-8">
          <div className="relative z-10">
            <h3 className="mb-4 font-headline text-2xl font-bold text-on-surface">Komisyon Hesaplayıcı</h3>
            <p className="max-w-md text-on-surface-variant">
              24 kurum, 8 piyasa ve tüm masraf kalemleriyle toplam efektif maliyeti tek ekranda görün.
            </p>
          </div>
          <div className="relative z-10 mt-8 flex gap-4">
            <div className="rounded-xl border border-outline-variant/35 bg-surface-container-high p-4 shadow-sm">
              <p className="mb-1 font-label text-xs font-bold uppercase text-on-surface-variant">Kurum Kapsamı</p>
              <p className="font-headline text-2xl font-bold text-secondary">24 Kurum</p>
            </div>
            <div className="rounded-xl border border-outline-variant/35 bg-surface-container-high p-4 shadow-sm">
              <p className="mb-1 font-label text-xs font-bold uppercase text-on-surface-variant">Masraf Katmanı</p>
        ...
        <div className="flex flex-col rounded-3xl border border-outline-variant/35 bg-surface-container-lowest p-8 shadow-sm md:col-span-4">
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-info-container">
            <LineChart className="h-6 w-6 text-secondary" strokeWidth={1.5} />
          </div>
          <h3 className="mb-4 font-headline text-2xl font-bold text-on-surface">Korelasyon Çarpışması Testi</h3>
        ...
        <div className="glass-panel flex flex-col items-center justify-center rounded-3xl p-8 text-center md:col-span-4">
          ...
          <h3 className="font-headline text-xl font-bold text-on-surface">Portföy Stres Simülatörü</h3>
          <p className="mt-2 text-sm text-on-surface-variant">
            Monte Carlo, CVaR ve kriz kütüphanesiyle portföyün kırılma noktasını ölçün.
          </p>
        </div>

        <div className="glass-panel flex flex-col items-center gap-8 rounded-3xl p-8 md:col-span-8 md:flex-row">
          <div className="w-full md:w-1/3">
            <div className="mb-3">
              <Radar className="h-6 w-6 text-secondary" strokeWidth={1.5} />
            </div>
            <h3 className="mb-4 font-headline text-2xl font-bold text-on-surface">FinCognis API Çıktıları</h3>
            <p className="text-on-surface-variant">Araç sonucunu rapor, panel veya operasyon akışına tek formatta aktar.</p>
          </div>
          <div className="w-full overflow-x-auto rounded-xl border border-outline-variant/35 bg-surface-container-lowest p-4 font-mono text-sm text-info md:w-2/3">
