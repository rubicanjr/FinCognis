  ...
  return (
    <section id="security" className="relative overflow-hidden bg-surface-container-low py-24">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-2">
        <div>
          <p className="mb-4 font-label text-sm font-bold uppercase tracking-[0.2em] text-secondary">Guvenli Islemler</p>
          <h2 className="mb-6 font-headline text-4xl font-extrabold leading-tight text-on-surface md:text-5xl">
            Sifir Guven Altyapisi.
          </h2>
          <p className="mb-10 text-lg leading-relaxed text-on-surface-variant">
            Her bayt veri AES-256 ile sifrelenir ve cografi olarak dagitilmis kasalarda saklanir.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-headline font-bold text-on-surface">Uctan Uca Sifreleme</h4>
                <p className="text-sm text-on-surface-variant">Her islem katmaninda ileri seviye protokoller.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-headline font-bold text-on-surface">Biyometrik Cok Faktorlu Dogrulama</h4>
                <p className="text-sm text-on-surface-variant">Davranis kaliplari dahil gelismis kimlik dogrulama.</p>
              </div>
            </div>
          </div>
        </div>
