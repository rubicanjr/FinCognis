    ...
    <>
      <div className="mt-4 grid gap-4 lg:grid-cols-2">
        <div className="rounded-2xl bg-surface p-4">
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-secondary">12) Hesaplama Geçmişi</p>
          <div className="max-h-56 space-y-2 overflow-auto pr-1">
            ...
            {historyItems.length === 0 && <p className="text-sm text-on-surface-variant">Kayıtlı geçmiş yok.</p>}
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-surface p-4">
          ...
          >
            "Bu kurumun oranı değişti" bildir
          </button>
      ...
      <div className="mt-4 rounded-2xl bg-surface p-4">
        ...
        >
          {showAdminPanel ? "Admin Panelini Gizle" : "Admin Paneli (Tarife Yönetimi)"}
        </button>
              ...
              <table className="w-full min-w-[720px] text-xs">
                <thead>
                  <tr className="text-left text-on-surface-variant">
                    ...
                    <th className="px-2 py-2">İlk Kademe Oranı</th>
