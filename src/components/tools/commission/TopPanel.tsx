    ...
    <>
      ...
      <div className="mb-6 grid gap-3 md:grid-cols-4">
        <div className="rounded-2xl bg-surface p-4">
          <p className="text-[11px] uppercase tracking-[0.16em] text-on-surface-variant">Islem Buyuklugu</p>
          <p className="mt-1 font-headline text-xl font-bold text-on-surface">{formatMoney(notional, currency)}</p>
        </div>
        <div className="rounded-2xl bg-surface p-4">
          <p className="text-[11px] uppercase tracking-[0.16em] text-on-surface-variant">Karsilastirilan Kurum</p>
        ...
        <div className="rounded-2xl bg-surface p-4">
          <p className="text-[11px] uppercase tracking-[0.16em] text-on-surface-variant">Maliyet Araligi</p>
